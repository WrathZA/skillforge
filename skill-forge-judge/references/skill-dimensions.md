...
**MANDATORY — Load the agentskills spec via the Spec Cache in SKILL.md Step 0 before scoring this dimension.** Score against the live spec, not baked-in knowledge — requirements may have changed.
